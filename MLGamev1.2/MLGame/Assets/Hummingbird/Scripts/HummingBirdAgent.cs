...
public class HummingBirdAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        //Zero out velocities so that movement stops before a new episdoe begins
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        //(+1 means that the beak is pointing directly at the lfower, -1 means directly away)
    ...
    /// <summary>
    /// Resume agent and taking actions
    /// </summary>
    ...
    /// <summary>
    /// Move the agent to a safe random position (i.e. does not collid with anything)
    ...
    private void TriggerEnterOrStay(Collider collider)
    {
        ...
        if (collider.CompareTag("nectar"))
        {
            ...
            //Check if the closest collision point is close to teh beak tip
    ...
    {
        //Avoids scenario where nearest flower has no nectar before reaching it
