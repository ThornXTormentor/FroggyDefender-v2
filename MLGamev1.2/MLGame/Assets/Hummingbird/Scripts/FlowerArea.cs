...
public class FlowerArea : MonoBehaviour
{
    ...
    // used for observing the relative distance from agent to flwoer
    ...
    private void FindChildFlowers(Transform parent)
    {
        for(int i = 0; i < parent.childCount; i++)
        {
            ...
            {
                // Found a flower, add it to the flowerPlants list
            ...
            else
            {
                ...
                if(flower != null)
                {
                    ...
                    //Note: there are no flowers that are childre of other flowers
                }
                else
                {
